 ...
 * Changelog:
 *
 *   2009/10/13     CCChang add this file for nuvoton N9H20 MCU ip REG.
 */
...
/* Timer Registers */
//#define TMR_BA		N9H20_VA_TIMER	/* Timer */
...
#define REG_LCM_MPUCMD 			(VPOST_BA+0x20)		// R/W: MPU-type LCD Command Register
	...
	#define MPUCMD_MPU68			BIT23				// MPU interface selection, reserved in N9H20
...
#define REG_LCM_TVCtl			(VPOST_BA+0x40)		// R/W: TvControl Register
	...
	#define TVCtl_TvCMM 			BIT16				// TV Color Modulation Method, reserved in N9H20
															//   1 = 27 MHz, 0 = 13.5 MHz 
...
*/
//#define DMAC_BA		N9H20_VA_SIC		/* SIC Control */
...
//#define FMI_BA		(N9H20_VA_SIC+0x800)	/* Flash Memory Card Interface */
...
//#define JPEG_BASE	N9H20_VA_JPEG		/* Jpeg Control */
...
//#define AIC_BA		N9H20_VA_IRQ		/* Interrupt Controller */
...
//#define SPU_BA		N9H20_VA_SPU


/* ADC Control Registers */
//#define ADC_BA		N9H20_VA_ADC


/* GPIO Control Registers */
//#define GPIO_BA		N9H20_VA_GPIO		/* GPIO Control */
/*
...
//#define PA_VA_USB_BASE	N9H20_VA_USBD
...
//#define I2C_BASE	N9H20_VA_I2C	/* I2CH Control */
...
//#define SPI_BASE_0	(N9H20_VA_SPI0)
...
//#define SPI_BASE_1	(N9H20_VA_SPI1)
